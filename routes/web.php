...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('book.report',BookReportController::class)->only(['create', 'store'])->scoped(['book'=>'slug'])->names([
        'create' => 'books.report.create',
        'store' => 'books.report.store',
    ]);

    Route::prefix('user')->name('user.')->group(function(){
        Route::resource('books',BookController::class)->except(['create', 'store', 'show'])->names(['index'=>'books.list'])->scoped(['book' => 'slug']);
